                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: "10px" }}>
                    ...
                    <div className="offcanvas offcanvas-start text-bg-dark" tabIndex={ -1 } id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                        ...
                        <div className="list-group list-group-flush">
                            ...
                            <Link to={'/'} className="list-group-item bg-dark text-white py-1 border-dark link-hover" style={{ fontSize: '16px', width: 'fit-content', display: 'inline-block', padding: 0 }}>Lista de clientes</Link>
                            <div className="list-group list-group-flush my-4">
                                <div className="fw-bold my-2" style={{ fontSize: '20px' }}>Cadastro</div>
                                <Link to={ '/cadastro' } className="list-group-item bg-dark text-white py-1 border-dark link-hover" style={{ fontSize: '16px', width: 'fit-content', display: 'inline-block', padding: 0 }}> cadastrar um novo cliente </Link>
                            </div>
                            </div>
                        </div>
                    </div>
